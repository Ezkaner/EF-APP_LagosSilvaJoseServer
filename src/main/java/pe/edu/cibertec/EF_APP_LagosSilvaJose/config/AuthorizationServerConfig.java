package pe.edu.cibertec.EF_APP_LagosSilvaJose.config;
...
public class AuthorizationServerConfig {
    ...
    public AuthorizationServerConfig(UsuarioRepository usuarioRepository) {
        ...
        try {
            ...
            throw new RuntimeException("[X] Error al generar claves.", ex);
        }
    }
    ...
    public UserDetailsService userDetailsService() {
        return username -> usuarioRepository.findByCodigo(username)
                .map(usuario -> User.withUsername(usuario.getCodigo())
                        ...
                        .build())
                .orElseThrow(() -> new UsernameNotFoundException("[X] El usuario no fue encontrado: " + username));
    }
